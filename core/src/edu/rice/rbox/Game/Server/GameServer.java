...
public class GameServer {
  ...
  private GameServiceImplBase gameServiceImplBase = new GameServiceImplBase() {
    @Override
...
//      System.out.println("Moved Rooms?: " + (((Integer) request.getMovingRoomsValue())).toString());
    ...
    public void getAssignedSuperPeer(GameNetworkProto.PlayerID request,
      ...
      // noop
      responseObserver.onNext(GameNetworkProto.SuperPeerInfo.getDefaultInstance());
      responseObserver.onCompleted();
    }
  ...
  public GameServiceImplBase getGameServiceImplBase() {return this.gameServiceImplBase;}

  public GameServer(GameStateManager stateManager) {
...
//                        .addService(new GameServer(null, ServerUUID.randomUUID()))
