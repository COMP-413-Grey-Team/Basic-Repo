...
public final class ConnectionServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<Network.ServerInformation,
      Network.ConnectionConfirmation> METHOD_CONNECT_TO =
      io.grpc.MethodDescriptor.<Network.ServerInformation, Network.ConnectionConfirmation>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "ConnectionService", "connectTo"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              Network.ServerInformation.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              Network.ConnectionConfirmation.getDefaultInstance()))
  ...
  public static abstract class ConnectionServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void connectTo(Network.ServerInformation request,
        io.grpc.stub.StreamObserver<Network.ConnectionConfirmation> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                Network.ServerInformation,
                Network.ConnectionConfirmation>(
  ...
  public static final class ConnectionServiceBlockingStub extends io.grpc.stub.AbstractStub<ConnectionServiceBlockingStub> {
     ...
     * </pre>
     */
    public Network.ConnectionConfirmation connectTo(Network.ServerInformation request) {
  ...
  public static final class ConnectionServiceFutureStub extends io.grpc.stub.AbstractStub<ConnectionServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<Network.ConnectionConfirmation> connectTo(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONNECT_TO:
          serviceImpl.connectTo((Network.ServerInformation) request,
              (io.grpc.stub.StreamObserver<Network.ConnectionConfirmation>) responseObserver);
          break;
        default:
